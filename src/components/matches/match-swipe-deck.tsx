  ...
  return (
    ...
    >
      ...
      <Card className="overflow-hidden shadow-xl border-border/80">
        <button
          type="button"
          className="relative block w-full h-72 sm:h-80 bg-gradient-to-br from-accent to-accent/50 dark:from-primary/20 dark:to-primary/10"
          onClick={onView}
        >
          {match.imageUrl ? (
            <LazyImage
...
export function MatchSwipeDeck({
  ...
  return (
    <div className="relative min-h-[32rem] pb-2">
      <motion.div
        key={current.userId}
