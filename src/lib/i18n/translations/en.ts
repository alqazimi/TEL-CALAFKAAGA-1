export const en = {
  ...
  landing: {
    ...
    step2Desc:
      "Men choose Basic ($5) or Premium ($20). Women get Basic free and can upgrade to Premium.",
  ...
  faq: {
    ...
    a3: "Men: Basic is $5 or Premium is $20 (one-time). Women: Basic is free; Premium ($20) is optional. Both plans include the same app features. Premium adds WhatsApp support and help finding your match.",
    ...
    q6: "What is Premium?",
    a6: "Premium ($20) includes everything in Basic, plus personal WhatsApp support and staff help searching for the right match for you.",
  ...
  pricing: {
    ...
    membership: "Basic",
    basicDesc: "Men $5 · Women free — full app access.",
    premiumMembership: "Premium",
    premiumDesc:
      "Everything in Basic, plus WhatsApp support and we search for your match ($20).",
    payOnce: "Men pay once for Basic. Women get Basic free. Premium is optional for everyone.",
    planChoiceLater:
      "Men choose a plan after completing their profile. Women get Basic free and can upgrade anytime.",
  ...
  howItWorks: {
    ...
    step2Desc:
      "Men: Basic ($5) or Premium ($20). Women: Basic free — upgrade to Premium if you want WhatsApp help and match search.",
