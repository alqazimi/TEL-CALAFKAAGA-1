export const en = {
  ...
  payment: {
    ...
    evcSubtitle:
      "Send the plan amount to one of the numbers below (EVC, M-PESA, or Telebirr), then upload your payment screenshot for admin approval.",
    ...
    ethiopiaLabel: "Telebirr (Ethiopia)",
    evcHowTo:
