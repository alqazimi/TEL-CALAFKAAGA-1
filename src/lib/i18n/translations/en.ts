export const en = {
  ...
  auth: {
    ...
    verifyEmailDesc: "We sent an 8-digit code to {{email}}. Enter it below to continue.",
    verifyCode: "Verification code",
    verifyCodeSent: "Check your email for a verification code.",
    verifyFailed: "Invalid code. Please try again.",
    verifying: "Verifying...",
    verifyAndContinue: "Verify & continue",
    backToAccount: "Back to account details",
    loginVerifyDesc:
      "Your email isn't verified yet. We sent an 8-digit code to {{email}} — enter it below to sign in.",
