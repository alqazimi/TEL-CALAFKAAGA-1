export const en = {
  ...
  auth: {
    ...
    resetDesc: "Enter your email and we'll send a password reset link if an account exists.",
    ...
    resetting: "Updating...",
    resetCodeSent: "If an account exists for that email, a reset link has been sent. Check your inbox and spam folder.",
    resetCodeResent: "If an account exists, a new reset link has been sent.",
