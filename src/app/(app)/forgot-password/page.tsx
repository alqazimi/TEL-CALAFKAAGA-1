 ...
 * 1) Request a code by email
 * 2) Submit code + new password together (server verifies both)
 *
 * Not wrapped in GuestGate — anyone who forgot their password must reach this page,
 * including staff who still have a stale session.
 */
export default function ForgotPasswordPage() {
  ...
  const onRequestReset = async (data: EmailForm) => {
    ...
    try {
      ...
      // Same success copy for unknown emails — avoid account enumeration.
